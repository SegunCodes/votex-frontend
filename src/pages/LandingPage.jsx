...
const LandingPage = ({ onConnectWallet, isWalletConnected, walletAddress, setActiveView, message, showMessage }) => {
  return (
    <div className="min-h-screen bg-gray-900 text-white font-inter flex flex-col">
      ...
      <nav className="p-6 flex justify-between items-center bg-gray-800 rounded-b-xl shadow-lg">
        ...
        <button
          onClick={() => setActiveView('voterRegistration')}
          className="px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-500 text-white font-semibold rounded-full shadow-lg hover:from-purple-700 hover:to-pink-600 transition-all duration-300 transform hover:scale-105"
        >
          Join Vote
        </button>
      </nav>
      ...
      <section className="p-8 pb-16 bg-gray-850 grid grid-cols-1 md:grid-cols-2 gap-8 lg:grid-cols-4 rounded-t-xl shadow-inner">
        ...
        <div className="flex flex-col items-center p-6 bg-gray-700 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 transform hover:-translate-y-1">
          <svg xmlns="[http://www.w3.org/2000/svg](http://www.w3.org/2000/svg)" className="h-12 w-12 text-teal-400 mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="flex flex-col items-center p-6 bg-gray-700 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 transform hover:-translate-y-1">
          <svg xmlns="[http://www.w3.org/2000/svg](http://www.w3.org/2000/svg)" className="h-12 w-12 text-blue-400 mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="flex flex-col items-center p-6 bg-gray-700 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 transform hover:-translate-y-1">
          <svg xmlns="[http://www.w3.org/2000/svg](http://www.w3.org/2000/svg)" className="h-12 w-12 text-yellow-400 mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="flex flex-col items-center p-6 bg-gray-700 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 transform hover:-translate-y-1">
          <svg xmlns="[http://www.w3.org/2000/svg](http://www.w3.org/2000/svg)" className="h-12 w-12 text-red-400 mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 10l4.879-4.879A1 1 0 0121 6.121v7.757a1 1 0 01-1.707.707L15 10zm-3 8h-2m2 0c1.065 0 2.062-.358 2.879-1H20.75a1 1 0 00.912-1.405l-3.374-7.054C18.257 8.358 17.159 8 16 8h-4a2 2 0 00-2 2v4a2 2 0 002 2zm-5 0H4.25a1 1 0 01-.912-1.405l3.374-7.054C5.743 8.358 6.841 8 8 8h4a2 2 0 002 2v4a2 2 0 00-2 2zm-5 0h-2m2 0c-1.065 0-2.062-.358-2.879-1H3.25a1 1 0 00-.912 1.405l3.374-7.054C5.743 8.358 6.841 8 8 8h4a2 2 0 002 2v4a2 2 0 00-2 2z" />
          </svg>
      ...
      <section className="bg-gray-900 py-16 px-8 text-center">
        ...
        {!isWalletConnected ? (
          ...
          <div className="flex flex-col items-center">
            ...
            {/* If wallet is connected, navigate to voter registration immediately */}
            <button
              onClick={() => setActiveView('voterRegistration')}
