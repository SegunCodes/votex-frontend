...
export const uploadImage = (imageBase64) => makeRequest('/admin/upload-image', 'POST', { imageBase64 }, true); // New endpoint for image upload
...
export const getElectionResultsPublic = (electionId, gender = null, ageRange = null) => {
    ...
    return makeRequest(`/elections/${electionId}/results?${query}`, 'GET');
};